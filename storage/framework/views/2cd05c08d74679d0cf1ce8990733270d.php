...
<body>
    ...
    <div id="loginToast" class="auth-toast-login">
        ⚠️ <span><?php echo e(session('auth_required')); ?></span>
    </div>
    <script>
        setTimeout(() => {
    ...
    <div class="auth-container">
        <div class="auth-image-section">
            <img src="<?php echo e(asset('images/auth_bg.png')); ?>" alt="BojongStore">
        </div>
            ...
            <div class="auth-form-wrapper">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Masukkan email anda" required autofocus />
                    </div>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" style="font-size: 13px; color: var(--green-primary); text-decoration: none;">Lupa password?</a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="social-login">
                    <a href="<?php echo e(route('social.redirect', 'google')); ?>" class="social-btn social-btn-g" title="Login dengan Google">
...
<?php /**PATH D:\SMT 6\PPL\clone ppl\BojongStore\resources\views/auth/login.blade.php ENDPATH**/ ?>