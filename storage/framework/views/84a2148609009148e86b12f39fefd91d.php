  ...
  <section class="hero" id="hero">
    <div class="hero-container">
      ...
      <div class="hero-content">
        ...
        <a href="<?php echo e(route('katalog')); ?>" class="btn btn-primary" id="btnMulaiBelanja"
      ...
      <div class="hero-visual">
        <div class="hero-char char-girl">
          <img src="<?php echo e(asset('images/char2.png')); ?>" alt="UMKM Seller">
        </div>
        <div class="hero-char char-mustache">
          <img src="<?php echo e(asset('images/char1.png')); ?>" alt="UMKM Seller">
        </div>
        <div class="hero-char char-dark">
          <img src="<?php echo e(asset('images/char_dark.png')); ?>" alt="UMKM Seller">
        </div>

        <!-- Floating Badge -->
        <?php if($mostViewedProduct): ?>
          <div class="hero-floating-badge" id="heroBadge">
            <div class="badge-icon">
              <img src="<?php echo e(asset('images/logo_pot.png')); ?>" alt="BojongStore">
            </div>
            <div class="badge-text">
              <strong>Produk Terpopuler</strong>
              <?php echo e($mostViewedProduct->name); ?>, telah dilihat sebanyak <?php echo e($mostViewedProduct->views); ?> kali
            </div>
          </div>
        <?php endif; ?>
      </div><!-- /.hero-visual -->
    ...
    <div class="section-container">
      ...
      <div class="testi-grid">
        ...
        <div class="testi-card blue-card">
          ...
          <div class="testi-author">
            <div class="author-avatar">
              <img src="<?php echo e(asset('images/ibu_ani_avatar.png')); ?>" alt="Ibu Ani">
            </div>
            <div>
        ...
        <div class="testi-card yellow-card">
          ...
          <div class="testi-author">
            <div class="author-avatar">
              <img src="<?php echo e(asset('images/pak_budi_avatar.png')); ?>" alt="Pak Budi">
            </div>
            <div>
        ...
        <div class="testi-card gray-card">
          ...
          <div class="testi-author">
            <div class="author-avatar">
              <img src="<?php echo e(asset('images/mas_danu_avatar.png')); ?>" alt="Mas Danu">
            </div>
            <div>
      ...
      <div class="footer-grid">
        ...
        <div class="footer-column">
          ...
          <ul class="footer-links">
            <li><a href="<?php echo e(route('katalog', ['category' => 1])); ?>">Sayuran</a></li>
            <li><a href="<?php echo e(route('katalog', ['category' => 2])); ?>">Buah-buahan</a></li>
            <li><a href="<?php echo e(route('katalog', ['category' => 2])); ?>">Kerajinan Tangan</a></li>
            <li><a href="<?php echo e(route('katalog', ['category' => 4])); ?>">Makanan Olahan</a></li>
            <li><a href="<?php echo e(route('katalog', ['category' => 5])); ?>">Minuman</a></li>
            <li><a href="<?php echo e(route('katalog', ['category' => 6])); ?>">Jasa</a></li>
          </ul>
        </div>
        <div class="footer-column">
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SMT 6\PPL\clone ppl\BojongStore\resources\views/home.blade.php ENDPATH**/ ?>