            ...
            <form method="POST" action="<?php echo e(route('profile.update')); ?>">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-field">
                        ...
                        <input type="tel" id="telepon" name="telepon" value="<?php echo e(old('telepon', $user->telepon)); ?>" placeholder="+62 8xxx-xxxx-xxxx">
                    </div>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="negara" name="negara" value="<?php echo e(old('negara', $user->negara ?? 'Indonesia')); ?>" placeholder="Indonesia">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SMT 6\PPL\clone ppl\BojongStore\resources\views/profile/edit.blade.php ENDPATH**/ ?>