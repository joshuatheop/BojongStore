  ...
  <div class="hero-container">
    ...
    <div class="hero-visual">
      <div class="hero-char char-girl">
        <img src="{{ asset('assets/images/char2.png') }}" alt="UMKM Seller">
      </div>
      <div class="hero-char char-mustache">
        <img src="{{ asset('assets/images/char1.png') }}" alt="UMKM Seller">
      </div>
      <div class="hero-char char-dark">
        <img src="{{ asset('assets/images/char_dark.png') }}" alt="UMKM Seller">
      </div>

      <!-- Floating Badge -->
      <div class="hero-floating-badge" id="heroBadge">
        <div class="badge-icon">
          <img src="{{ asset('assets/images/logo_pot.png') }}" alt="BojongStore" style="width:24px;height:24px;object-fit:contain;">
        </div>
