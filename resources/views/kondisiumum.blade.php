...
<section class="relative w-full py-20 bg-green-600 z-0 shadow-inner">
    ...
    <div class="max-w-4xl mx-auto text-center px-6">
        <h1 class="text-4xl sm:text-5xl font-extrabold text-white mb-4">Kondisi Umum Desa</h1>
        <p class="text-white text-lg max-w-2xl mx-auto">
            Desa Banjarsari merupakan salah satu desa di Kecamatan Bayongbong, Kabupaten Garut, dengan karakteristik wilayah, sosial, dan sumber daya yang mencerminkan potensi untuk berkembang secara berkelanjutan.
        </p>
    </div>
</section>
